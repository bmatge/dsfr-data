...
export class PasswordChangeModal extends LitElement {
  ...
  render() {
    ...
    return html`
      <dialog class="fr-modal fr-modal--opened" role="dialog" aria-labelledby="pw-change-title" aria-modal="true"
            ...
            <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
              <div class="fr-modal__body">
                ...
                <div class="fr-modal__content">
                  <h1 id="pw-change-title" class="fr-modal__title">
                  ...
                  ${!this._success ? html`
                    <form @submit=${this._handleSubmit}>
                      <div class="fr-input-group">
                        ...
                        <input class="fr-input" type="password" id="pw-current" autocomplete="current-password"
                               .value=${this._currentPassword}
                               @input=${(e: Event) => { this._currentPassword = (e.target as HTMLInputElement).value; }}
                               required>
                      </div>

                      <div class="fr-input-group">
                        <label class="fr-label" for="pw-new">Nouveau mot de passe</label>
                        <input class="fr-input" type="password" id="pw-new" autocomplete="new-password"
                               minlength="8"
                      ...
                      <div class="fr-input-group">
                        <label class="fr-label" for="pw-confirm">Confirmer le nouveau mot de passe</label>
                        <input class="fr-input" type="password" id="pw-confirm" autocomplete="new-password"
                               minlength="8"
                  ...
                  ` : html`
                    <div class="fr-input-group" style="margin-top:1rem">
                      <button class="fr-btn fr-btn--secondary" @click=${() => this.close()}
                              style="width:100%">
                        Fermer
                      </button>
                    </div>
