...
export const REPERES = [
  ...
  {"id":"playground.actions.studio","genre":"controle","libelle":"Envoyer au Studio IA","element":"button","zone":"playground.actions","attributs":[],"prerequis":[],"synonymes":["studio","studio ia","reconstruire"],"sources":["apps/playground/index.html"]},
