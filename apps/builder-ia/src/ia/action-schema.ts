...
import { CHART_CONFIG_TYPES, CHART_CONFIG_SCHEMA } from '@dsfr-data/shared';

// Vocabulaire et schema de la ChartConfig : promus dans @dsfr-data/shared
// (#515), re-exportes sous leurs noms historiques — imports et tests intacts.
export const CHART_TYPES = CHART_CONFIG_TYPES;
export { AGGREGATIONS, SORT_ORDERS, VARIANTS } from '@dsfr-data/shared';
...
/** Schema du config de createChart, calque sur ChartConfig (source : shared). */
export const CONFIG_SCHEMA = CHART_CONFIG_SCHEMA;
