  ...
  plugins: [
    {
      ...
      configureServer(server) {
        ...
        // IA_MAX_RPM lu dans l'environnement du process ou dans le .env racine.
        const iaDebit = creerDebit({
          maxParMinute: lireMaxRpm(process.env.IA_MAX_RPM ?? rootEnv.IA_MAX_RPM),
        });
